      ...
      return (
        <div className="mb-2.5">
          ...
          <input
            ...
            className="w-full px-2 py-1.5 rounded border border-border-default bg-bg-2 text-text-0 text-xs outline-none focus:border-brand"
          />
        </div>
      )
      ...
      return (
        <div className="mb-2.5">
          ...
          <textarea
            ...
            onChange={(e) => onChange(e.target.value)}
            rows={3}
            className="w-full px-2 py-1.5 rounded border border-border-default bg-bg-2 text-text-0 text-xs outline-none focus:border-brand resize-y"
          />
        </div>
      )
      ...
      return (
        <div className="mb-2.5">
          ...
          <select
            value={String(value || '')}
            onChange={(e) => onChange(e.target.value)}
            className="w-full px-2 py-1.5 rounded border border-border-default bg-bg-2 text-text-0 text-xs outline-none focus:border-brand cursor-pointer"
          >
      ...
      return (
        <div className="mb-2.5">
          ...
          {items.map((item, i) => (
            <div key={i} className="flex gap-1 mb-1">
              <input
                ...
                className="flex-1 px-2 py-1 rounded border border-border-default bg-bg-2 text-text-0 text-xs outline-none focus:border-brand"
              />
              <button
          ...
          <button
            ...
            className="text-[10px] text-brand hover:text-brand-dim transition-colors mt-0.5"
          >
            + Add item
          </button>
        </div>
              ...
              {Object.entries(item).map(([key, val]) => (
                <div key={key} className="mb-1">
                  ...
                  <input
                    ...
                    className="w-full px-1.5 py-1 rounded border border-border-subtle bg-bg-3 text-text-0 text-[11px] outline-none focus:border-brand"
                  />
                </div>
              ))}
            </div>
  ...
  return (
    <>
      ...
      <div className="px-3.5 py-3 border-b border-border-default flex items-center justify-between">
        ...
        <span className="text-[10px] px-2 py-0.5 rounded-full bg-brand-glow text-brand font-semibold">
          {block.type}
        </span>
      </div>
