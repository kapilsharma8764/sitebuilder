      ...
      <div className="relative flex flex-col items-center gap-8 max-w-md px-8">
        ...
        <div className="relative w-[200px] h-[130px] rounded-lg border border-border-default bg-bg-1/80 overflow-hidden">
          ...
          <div className="absolute top-0 left-0 right-0 h-4 bg-bg-3/60 flex items-center px-2 gap-1">
            <div className="w-6 h-1.5 rounded-sm bg-brand/40" />
          ...
          <div className="absolute top-6 left-3 right-3 space-y-1.5">
            <div className="h-2 w-16 rounded-sm bg-brand/30 gen-shimmer" style={{ animationDelay: '0ms' }} />
            ...
            <div className="flex gap-1.5 pt-1">
              <div className="h-3 w-12 rounded-sm bg-brand/40 gen-shimmer" style={{ animationDelay: '300ms' }} />
          ...
          {/* Scan line */}
          <div className="absolute left-0 right-0 h-px bg-brand/40 gen-scan" />
        </div>
        ...
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-2 text-brand text-[13px] tabular-nums">
            ...
            <div key={step.label} className="flex items-center gap-3">
              ...
              {i === activeStep && (
                <div className="flex-1 h-1 rounded-full bg-bg-3 overflow-hidden ml-auto max-w-[80px]">
                  <div className="h-full bg-brand/60 rounded-full gen-progress" />
                </div>
              )}
            </div>
          ))}
