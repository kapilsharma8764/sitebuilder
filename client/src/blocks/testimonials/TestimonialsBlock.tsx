...
const defaultTestimonials: Testimonial[] = [
  { name: 'Sarah Chen', role: 'CEO at TechCorp', quote: 'SiteBuilder completely changed how we build landing pages. The JSON config approach is genius.', rating: 5 },
    ...
    <section className="px-6 @md:px-10 py-16 @md:py-20">
      ...
      <div className="grid grid-cols-1 @2xl:grid-cols-3 gap-4">
        {items.map((item, i) => (
          ...
          >
            <Quote size={20} className="text-brand/30 mb-3" />
    ...
    <section className="px-6 @md:px-10 py-16 @md:py-20">
      ...
      <div className="reveal-fade-up reveal-d2 max-w-2xl mx-auto">
        <div className="text-center">
          <Quote size={32} className="text-brand/20 mx-auto mb-4" />
              ...
              {items.map((_, i) => (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-colors ${
                    i === safeIndex ? 'bg-brand' : 'bg-bg-4 hover:bg-bg-5'
                  }`}
                />
              ))}
            </div>
  ...
  return (
    <section className="px-6 @md:px-10 py-16 @md:py-24">
      <div className="max-w-2xl mx-auto text-center">
        <div className="reveal-fade-up reveal-d1"><Quote size={48} className="text-brand/20 mx-auto mb-6" /></div>
