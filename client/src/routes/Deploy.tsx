              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-3 flex items-center gap-2">
                  <button
                    ...
                    disabled={publishing}
                    className="px-4 py-1.5 rounded-lg bg-brand text-bg-0 text-[12.5px] font-semibold hover:bg-brand/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1.5"
                  >
                    {publishing ? (
                      <>
